...
import { a as loadAgents, i as Status, n as Panel, r as Shell, t as Empty, w as useAuthedQuery, y as postRunRole } from "./use-authed-query-BluSw2KL.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/agents-Dp_ocGX8.js
					...
					children: [
						...
						open === r.id ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								run.data?.task && open === r.id ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "mt-2 rounded-md border border-border p-2 text-sm",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Status, { value: run.data.task.status }),
										run.data.task.interpretation ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "mt-2",
											children: run.data.task.interpretation
										}) : null,
										run.data.task.output_json ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", {
											className: "mt-2 overflow-x-auto whitespace-pre-wrap text-xs",
											children: run.data.task.output_json
										}) : null
									]
								}) : null
							]
