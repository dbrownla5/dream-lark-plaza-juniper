//#region node_modules/.nitro/vite/services/ssr/assets/db-Dw_TDOBo.js
...
async function createPgliteSql() {
	globalRef.__pgliteInstance__ ??= (async () => {
		...
		const { ensureDataDirs, pgliteDir } = await import("./data-dir-D6IkF-jd.mjs").then((n) => n.n).then((n) => n.n);
		ensureDataDirs();
		const pg = new PGlite(pgliteDir(), { parsers: {
			[OID_INT8]: Number,
			[OID_DATE]: identity,
	...
	const migrate = async () => {
		const migrations = /* #__PURE__ */ Object.assign({
			...
			"/migrations/0003_packages.sql": _0003_packages_default,
			"/migrations/0004_queue.sql": _0004_queue_default,
			"/migrations/0005_skills_user.sql": _0005_skills_user_default
		});
